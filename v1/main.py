"""
rental-analyst: Multi-agent Airbnb analytics system
...
def main():
    ...
    with open("outputs/full_analysis.md", "w", encoding="utf-8") as f:
        f.write(f"# Rental Analyst Report\n\n")
    ...
    print(f"{'='*60}")
    print(f"\nOutputs saved to:")
    print(f"  outputs/full_analysis.md")
    print(f"  outputs/executive_report.md")
    print(f"\n{result}")
